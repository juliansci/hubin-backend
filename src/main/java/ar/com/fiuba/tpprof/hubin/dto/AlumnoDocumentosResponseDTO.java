...
public class AlumnoDocumentosResponseDTO {
    ...
    private List<DocumentoResponseDTO> documentosEliminados = new ArrayList<DocumentoResponseDTO>();
    ...
    public AlumnoDocumentosResponseDTO(Alumno alumno) {
        for (Documento documento : alumno.getDocumentosCreados()) {
            if (documento.isEliminado()) {
                documentosEliminados.add(new DocumentoResponseDTO(documento));
            } else {
    ...
    public List<DocumentoResponseDTO> getDocumentosEliminados() {
        return documentosEliminados;
    }

    public void setDocumentosEliminados(List<DocumentoResponseDTO> documentosEliminados) {
